# ttt/n9_enhanced_battle.py
"""
Battle evaluation for 9×9 enhanced convolution agent.

Usage:
  python -m ttt.n9_enhanced_battle \
    --probs data/n4_dual/n4_exhaustive_probs.json \
    --lambda_draw 0.3 \
    --games_random 500 \
    --out_json out/runs/n9_enhanced_lambda0.3.json \
    --record_losses \
    --seed 2025
"""
...
from ttt.n9_enhanced_convolution_agent import (
    EnhancedConvolutionAgent, RandomAgent9x9, SmartAgent9x9,
    play_game_9x9, N9
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate 9×9 enhanced convolution policy against baselines.")
    ...
    print(f"Loading enhanced convolution agent with λ={args.lambda_draw}...")
    enhanced_agent = EnhancedConvolutionAgent(args.probs, lambda_draw=args.lambda_draw, rng=rng)
    ...
    result_entry = {
        ...
        "agent_type": "enhanced_convolution"
    }
    ...
    if args.games_random > 0:
        ...
        res_random, loss_games_random = run_series(enhanced_agent, random_agent, args.games_random, rng, 
    ...
    if args.games_smart > 0:
        ...
        res_smart, loss_games_smart = run_series(enhanced_agent, smart_agent, args.games_smart, rng, 
                                                 record_losses=args.record_losses)
        ...
        with open(args.out_json, 'w') as f:
            json.dump({
                "config": {
                    ...
                    "seed": args.seed,
                    "board_size": "9x9",
                    "method": "enhanced_convolution_4x4",
                    "features": ["must_win", "must_block", "convolution", "fallback_heuristic"]
                },
    ...
    print("Summary:")
    print("-" * 80)
    print(f"λ={args.lambda_draw:.1f} ({args.lambda_draw*100:.0f}%) - Enhanced Convolution Agent:")
